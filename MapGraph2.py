...
class MapGraph2(WeightedListGraph):
    ...
    def addEdge(self, node1, node2, weight1="default"):
        ...
        weight2 = self._straightDist(node1, node2)
    ...
    for line in filObj:
        ...
        if line == "" or line[0] == '#':
            ...
            if row == numNodes:
                ...
                readingNodes = False
                graph = MapGraph2(numNodes, allData)
            ...
            [fromNode, toNode, weight] = [int(x) for x in line.split()]
